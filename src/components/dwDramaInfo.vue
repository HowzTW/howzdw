...
<template>
    <a-flex vertical gap="small" style="width: 100%; margin: 0px; padding: 0;" :key="componentKey">
        ...
        >
            ...
            <video :id="'dwPlayer'+siteAndId" :src="playEpisodeUrl" controls autoplay style="width: 400px; max-width: 70%;" @ended="PlayNext">
            ...
            <br /><input type="text" :value="playEpisodeUrl" style="width: 100%"/>
        </a-drawer>
